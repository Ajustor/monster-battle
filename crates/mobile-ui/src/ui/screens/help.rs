            ...
            let sections: &[(&str, Color, &[&str])] = &[
                ...
                (
                    ...
                    &[
                        ...
                        "Pas de mort de vieillesse : il vit tant",
                        "qu'il est nourri et survit aux combats",
                    ],
                ),
                (
                    "-- Systeme de faim --",
                ...
                (
                    ...
                    &[
                        ...
                        "FastLearner     > XP x1.5",
                        "Longevity       > vieillit plus lentement (+15j)",
                        "Glouton         > devore meme quand rassasie",
                    ],
                ),
                (
                    "-- Faim & Devoration --",
                    colors::ACCENT_GREEN,
                    &[
                        "Un monstre affame (💀) a ses stats reduites a 70%",
                        "Un monstre rassasie (😊) refuse de devorer",
                        "  sauf s'il a le trait Glouton",
                        "Devorer un ennemi vaincu ou un allie",
                        "  rend le monstre rassasie",
                        "Le trait Glouton permet de toujours devorer,",
                        "  quel que soit l'etat de faim",
                    ],
                ),
                (
                    "-- Commandes --",
